    ...
    <main className={styles.authorization}>
      ...
      <form className={styles.authorization__form} onSubmit={handleSubmit} noValidate>
        ...
        <p className={styles.authorization__msg}>
          Введите вашу почту для регистрации. На неё придёт код подтверждения, который нужно будет
          ввести в следующем окне.
        </p>
        ...
        <p className={styles.authorization__text}>
          ...
          <Link to="/auth/login" className={`${styles.authorization__link} clickable`}>
            {'-> Войти <-'}
          </Link>
        </p>
      </form>
