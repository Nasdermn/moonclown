...
import instIcon from '../../assets/images/socials/instagram.svg';
import telIcon from '../../assets/images/socials/telegram.svg';
import ytIcon from '../../assets/images/socials/youtube.svg';
  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.footer__content}>
        <span className={styles.footer__copyright}>© 2023-2025</span>
